...
- 风格 = 锁定的 **原创 2D 美漫科幻西部风格**:厚的深色卡通描边、大色块、
...
```text
original flat 2D American-comic sci-fi western game art,
graphic hand-inked comic look, thick clean dark cartoon outlines, large simple shape blocks, sparse interior lines, broad two-to-three-value cel shading,
