...
func _menu_button(text: String, cb: Callable, danger: bool = false) -> Button:
	...
	if danger:
		b.add_theme_color_override("font_color", T.ACCENT_DANGER)
		b.add_theme_color_override("font_hover_color", T.ACCENT_DANGER)
		b.add_theme_color_override("font_focus_color", T.ACCENT_DANGER)
