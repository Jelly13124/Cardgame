...
func _make_currency_chip(parent: Control, _icon_id: String, accent: Color) -> Label:
	...
	# TEXT PLACEHOLDER for the currency name — the icon PNGs are being regenerated by
	# Codex (ADR-0005). TODO: restore the TextureRect (home/currency/<id>.png) once the
	# clean icons land.
	var zh := Settings.language == "zh"
