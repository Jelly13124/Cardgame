...
2. **Navigate to Example**: Go to `BattleScene/BattleScene.tscn` in the FileSystem dock
...
```gdscript
# Key references in BattleScene.gd
...
```
BattleScene/
├── BattleScene.tscn          # Main scene file
├── BattleScene.gd           # Game logic and button handlers  
